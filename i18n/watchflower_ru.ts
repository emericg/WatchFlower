...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">На версиях Anrdoid 6 и выше, для поиска устройств Bluetooth Low Energy требуется доступ к вашему местоположению. Данное приложение не использует и не хранит информацию о вашем местоположении. Приносим извинения за неудобство.</translation>
    </message>
    <message>
